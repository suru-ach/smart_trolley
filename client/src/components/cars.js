        ...
        <>
            <div>
                <Tooltip
                    ...
                    color="white"
                >
                    <h1 className="text-4xl text-center m-20">Shop top categories</h1>
                    </Tooltip>
            </div>
            <div class="bg-grey grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-13 md:grid-cols-2 ">
